...
import com.yash.ems.repo.EmployeeSkillsRatingRepository;
...
public class FeedbackServiceImpl implements FeedbackService {
	...
	@Autowired
	private EmployeeSkillsRatingRepository employeeSkillsRatingRepository;
	...
	@Override
	public EmployeeFeedback getEmployeeFeedback(int employeeFeedbackId) {
		
		String methodName = "getEmployeeFeedback()";
		logger.info(methodName + " called"); 
		
		EmployeeFeedback employeeFeedback = employeeFeedbackRepository.findById(employeeFeedbackId)
					.orElseThrow(() -> new ResourceNotFoundException("Employee Feedback not fount with id = " + employeeFeedbackId));
	...
	@Override
	public EmployeeFeedback updateEmployeeFeedback(int employeeFeedbackId, EmployeeFeedback employeeFeedbackInput) {
		
		String methodName = "updateEmployeeFeedback()";
		logger.info(methodName + " called"); 
		
		if(employeeFeedbackInput != null) {
			...
			employeeFeedback.getEmployeeSkillsRatings().forEach(e -> ids.add(e.getId()));

			employeeFeedbackInput.setId(employeeFeedbackId);
			employeeFeedbackInput.setCreatedOn(LocalDateTime.now());
		
			employeeFeedback = employeeFeedbackRepository.save(employeeFeedbackInput);
	
			ids.forEach(e -> employeeSkillsRatingRepository.deleteById(e));
		}
		
		return employeeFeedbackInput;
	}
	...
	@Override
	public boolean deleteEmployeeFeedback(int id) {
		
		String methodName = "deleteEmployeeFeedback()";
		logger.info(methodName + " called for delete employee feedback");
		
		EmployeeFeedback employeeFeedback = employeeFeedbackRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Employee Feedback not found with id = " + id));
		
		employeeFeedbackRepository.deleteById(id);
