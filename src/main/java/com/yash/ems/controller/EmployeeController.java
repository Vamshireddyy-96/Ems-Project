...
//	}
	...
	//Get the data by using EmployeeId
	...
	return new ResponseEntity<Employee>(singleEmployeeData,HttpStatus.OK);
	...
	Employee singleEmployeeData = employeeService.getEmployeeData(id);
